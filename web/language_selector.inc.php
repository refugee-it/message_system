    ...
    if (is_array($languages) === true)
    {
        if (count($languages) > 0)
        {
            ...
            $html .= "<div class=\"".$cssClassLanguageselector."\">\n".
                     ...
                     "      <label for=\"languageselector_form_selectcaption\">".LANG_LANGUAGESELECTOR_DESCRIPTION."</label><br/>\n".
                     "      <select name=\"lang\" size=\"1\" class=\"".$cssClassLanguageselectorFormSelect."\" id=\"languageselector_form_selectcaption\">\n";
