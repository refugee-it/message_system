 ...
 */
/**
 * @file $/web/lang/en/message_delete.lang.php
...
define("LANG_PAGETITLE", "Delete message");
define("LANG_HEADER", "Delete message");
define("LANG_OPERATIONSUCCEEDED", "Message deleted successfully.");
define("LANG_OPERATIONFAILED", "Was unable to delete the message.");
