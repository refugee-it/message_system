...
define("LANG_STEP4_DOMAINROOTDESCRIPTION", "Please enter the domain and server path of the message system you're currently installing. This path will be used to construct absolute links to the message system on your server.");
